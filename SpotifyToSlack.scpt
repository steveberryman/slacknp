tell application "Spotify"
	...
	repeat until application "Spotify" is not running
		...
		if track_name ≠ current_track and track_artist ≠ current_artist and track_album ≠ current_track then
			...
			set current_artwork to artwork url of current track
...
*from*: " & current_album
			...
			set message_quote to my replace_chars(message_quote, "`", "'\\''")
			log message_quote
			set payload to "payload={\"channel\": \"" & slack_channel & "\", \"username\": \"" & slack_username & " (Music)\", \"text\": \"" & message_quote & "\", \"icon_url\": \"" & current_artwork & "\"}"
